    ...
    <Router>
      ...
      <div classNameName="mt-5" id='precio'>
        ...
        <Routes>
          ...
          <Route path="/blue/:ubicacion" element={<Dolar tipo='Blue' />} />

          <Route path="/oficial" element={<Dolar tipo='Oficial' />} />
          <Route path="/oficial/:ubicacion" element={<Dolar tipo='Oficial' />} />

          <Route path="/mep" element={<Dolar tipo='MEP' />} />
          <Route path="/mep/:ubicacion" element={<Dolar tipo='MEP' />} />
